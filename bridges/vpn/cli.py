...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--config", default=None, help="RNS configuration directory")
    parser.add_argument(
        "--loglevel", type=int, default=4, help="Reticulum log level (0..7)"
    )
    ...
    p_server.add_argument(
        "--uplink", required=True, help="host interface for MASQUERADE (e.g. eth0)"
    )
